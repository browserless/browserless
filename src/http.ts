...
export enum HTTPManagementRoutes {
  ...
  pressure = '/pressure?(/)',
  replays = '/replays?(/)',
  replay = '/replays/+([0-9a-zA-Z-_])?(/)',
  replayPlayer = '/replays/+([0-9a-zA-Z-_])/player?(/)',
  replayVideoPlayer = '/replays/+([0-9a-zA-Z-_])/video/player?(/)',
  replayVideoStatus = '/replays/+([0-9a-zA-Z-_])/video/status?(/)',
  replayVideoHls = '/replays/+([0-9a-zA-Z-_])/video/hls/**',
  sessions = '/sessions?(/)',
  static = '/',
}
