...
describe('/chrome/function API', function () {
  ...
  it('times out requests', async () => {
    ...
    await fetch(
      'http://localhost:3000/chrome/function?token=browserless&timeout=10',
      {
        body: JSON.stringify(body),
        headers: {
          'content-type': 'application/json',
  ...
  it('rejects requests that are unauthorized', async () => {
    ...
    await fetch('http://localhost:3000/chrome/function?token=bless', {
      body: JSON.stringify(body),
      headers: {
        'content-type': 'application/json',
      },
  ...
  it('allows requests without token when auth token is not set', async () => {
    ...
    await fetch('http://localhost:3000/chrome/function', {
      body: JSON.stringify(body),
      headers: {
        'content-type': 'application/json',
      },
