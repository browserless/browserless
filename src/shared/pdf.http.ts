...
export interface BodySchema {
  /**
   * An array of script tags to add to the page before generating the PDF.
   * Each object can contain properties like `url`, `path`, or `content`.
   */
  addScriptTag?: Array<Parameters<Page['addScriptTag']>[0]>;

  /**
   * An array of style tags to add to the page before generating the PDF.
   * Each object can contain properties like `url`, `path`, or `content`.
   */
  ...
  /**
   * The URL to navigate to before generating the PDF.
   */
  ...
  /**
   * The amount of time in milliseconds to wait before generating the PDF.
   */
