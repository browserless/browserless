...
(async () => {
  ...
  // Bundle @posthog/rrweb as IIFE for browser injection
  await build({
    entryPoints: [join(rootDir, 'node_modules/@posthog/rrweb/dist/rrweb.js')],
    bundle: true,
    format: 'iife',
    globalName: 'rrweb',
  ...
  // Bundle @posthog/rrweb-plugin-console-record as IIFE
  await build({
    entryPoints: [join(rootDir, 'node_modules/@posthog/rrweb-plugin-console-record/dist/rrweb-plugin-console-record.js')],
    bundle: true,
    format: 'iife',
...
// Bundled from @posthog/rrweb for browser injection
export const RRWEB_RECORD_SCRIPT = ${JSON.stringify(rrwebScript)};

// Bundled from @posthog/rrweb-plugin-console-record for browser injection
